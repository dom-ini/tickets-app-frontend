...
const alertVariants = cva(
  "relative w-full rounded-md border p-4 text-start [&>svg~*]:pl-8 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg]:w-4 [&>svg]:h-4",
  {
    variants: {
      variant: {
